...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    ...
    >
      <span
        className={`absolute left-1 inline-flex items-center justify-center w-4 h-4 bg-white dark:bg-slate-900 rounded-full shadow-sm transform transition-transform duration-200 ${theme === "dark" ? "translate-x-6" : "translate-x-0"
          }`}
      >
        {theme === "light" ? (
