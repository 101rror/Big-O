...
export const ComplexityVisualization: React.FC<
...
> = ({ timeComplexity, spaceComplexity }) => {
  ...
  return (
    <div className="space-y-4 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg transition-colors duration-200">
      <h4 className="font-medium text-slate-700 dark:text-slate-300 mb-3 transition-colors duration-200">
      ...
      <div className="space-y-3">
        <div>
          <div className="flex justify-between text-sm mb-1">
            ...
            <span className="font-mono font-medium text-slate-800 dark:text-slate-200 transition-colors duration-200">
              {timeComplexity}
            </span>
          </div>
